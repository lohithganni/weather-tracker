      ...
      {display && (
        <tr onClick={handleDisplay}>
          <td colSpan="6">
            ...
            <div style={{ flex: '2 1 100%', display: 'flex', justifyContent: 'flex-start', alignItems: 'center', marginBottom: '10px' }}>
                <img src={day.day.condition.icon} alt="weather icon" style={{ width: '100px', marginRight: '8px' }} />
                <div style={{ textAlign: 'center' }}> {day.day.condition.text} </div>
              </div>
